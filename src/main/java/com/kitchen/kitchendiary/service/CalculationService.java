...
public class CalculationService {
    ...
    public OrderCalc calculate(BigDecimal gross, BigDecimal commissionRate, BigDecimal gstRateOnComm, BigDecimal netReceived) {
        gross = nz(gross);
        ...
        BigDecimal gstOnComm = commission
                .multiply(gstRateOnComm)
                .divide(BigDecimal.valueOf(100), 2, RoundingMode.HALF_UP);

        BigDecimal netExpected = gross.subtract(commission).subtract(gstOnComm).setScale(2, RoundingMode.HALF_UP);

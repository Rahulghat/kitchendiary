...
public class OrderService {
  ...
  public OrderResponse create(
    ...
    Platform platform =
        platformRepository
            .findByIdAndBusinessId(platformId, businessId)
            .orElseThrow(
                () -> new IllegalArgumentException("Platform not found for this business"));

    var computed =
        calc.calculate(
            req.grossAmount(), req.commissionRate(), req.gstRateOnComm(), req.netReceived());
